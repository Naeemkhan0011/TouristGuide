...
const UserAccountSuccess = ({route}) => {
  console.log('route?.params',route?.params?.token,route?.params?.userData)
  ...
  return (
    <SafeAreaView
      ...
      onPress={() => {
        handleSuccess()
        // goToTopNavigation(config.routes.USER_LOGIN_SCREEN)
    }}
    buttonStyle={{
        // width:'90%',
        marginHorizontal:20,
...
export default UserAccountSuccess;
