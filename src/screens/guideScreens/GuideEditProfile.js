...
const GuideEditProfile = ({navigation}) => {
  ...
  const selectImage = () => {
    ...
    launchImageLibrary(options, response => {
      if (response.didCancel) {
        ...
        console.log('imgArray response', response);
        ...
        <View
          ...
          <View
            ...
            <TouchableOpacity
              ...
              <TouchableOpacity style={{width: '12%'}} onPress={() => {
                setShowPassportImage(!showPassportImage)
              }}>
                <Image
                  source={passportImage ? config.images.CLOSE_EYE_ICON : config.images.EYE_ICON}
                  style={{
                    width: 20,
                    height: 20,
                    tintColor: config.colors.lightGrey2Color,
                   ...
                   return (
                     ...
                     key={index}>
                      <View style={{
                       ...
                       {/* <Image
                         source={{uri: item?.uri}}
                         style={{height: 150, width: 150, resizeMode: 'cover',marginLeft:6,marginTop:7}}
                       /> */}
                       {/* <Text style={{textAlign:'center',marginTop:30}}>{`       +${filePathArray?.length - 7} more`}</Text> */}
                     </View>
                   );
                 })}
               </>
